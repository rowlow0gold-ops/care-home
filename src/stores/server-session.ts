...
export const useServerSessionStore = defineStore("server-session", () => {
  ...
  const POSITION_PAGES: Record<string, readonly string[] | typeof ALL> = {
    ...
    office_manager: ["residents", "schedule", "leave", "meals", "reports", "staff", "chat", "settings"], // 행정
    receptionist:   ["residents", "schedule", "leave", "meals", "reports", "staff", "chat", "settings"], // 접수
  };
